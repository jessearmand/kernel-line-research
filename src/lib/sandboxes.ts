...
export const FAMILIES: ArchFamily[] = [
  ...
  },
  {
    ...
    nestedDocker: "Docker Desktop inside the guest is a VM in a VM: nested virt, M3+, Linux guests only",
...
export const SYSTEMS: System[] = [
  ...
  },
  {
    ...
    nestedDocker: "Docker Desktop inside the guest is a VM inside a VM: nested virt, M3+, macOS 15. Otherwise the guest has no Linux kernel to hand a container.",
    ...
    caveats: [
      "macOS guests cannot nest: no VMs inside, and Docker Desktop in the guest needs an M3+ host",
  ...
  },
  {
    ...
    nestedDocker: "Linux guests on the Apple backend get nested virt on macOS 15 with M3+, so Docker inside a Linux guest works there. macOS guests cannot.",
...
export const THREATS: Threat[] = [
  ...
  },
  {
    ...
    outcomes: {
      ...
      ghostvm: { verdict: "contained", note: "No host docker.sock in the guest. Docker inside means Docker Desktop in the guest, which is a VM in a VM on an M3+." },
  ...
  },
  {
    ...
    outcomes: {
      ...
      ghostvm: { verdict: "partial", note: "The guest has no Linux kernel. Docker Desktop inside needs nested virt (M3+, macOS 15) and is a VM in a VM — compose works then, slowly." },
      ...
      utm: { verdict: "partial", note: "A Linux guest on the Apple backend with nested virt (M3+, macOS 15) runs Docker natively inside. A macOS guest cannot." },
